...
@section('style')
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('imgs/backend/logo.jpg')}}">
    <!-- Google Fonts
		============================================ -->
    ...
    <!-- nalika Icon CSS
        ============================================ -->
    <link rel="stylesheet" href="{{ asset('css/backend/nalika-icon.css')}}">
    <!-- owl.carousel CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('css/backend/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{ asset('css/backend/owl.theme.css')}}">
    <link rel="stylesheet" href="{{ asset('css/backend/owl.transitions.css')}}">
    <!-- animate CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('css/backend/animate.css')}}">
    <!-- normalize CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('css/backend/normalize.css')}}">
    <!-- meanmenu icon CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('css/backend/meanmenu.min.css')}}">
    <!-- main CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('css/backend/main.css')}}">
    <!-- morrisjs CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('css/backend/morrisjs/morris.css')}}">
    <!-- mCustomScrollbar CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('css/backend/scrollbar/jquery.mCustomScrollbar.min.css')}}">
    <!-- metisMenu CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('css/backend/metisMenu/metisMenu.min.css')}}">
    <link rel="stylesheet" href="{{ asset('css/backend/metisMenu/metisMenu-vertical.css')}}">
    <!-- calendar CSS
		============================================ -->
    ...
    <!-- responsive CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('css/backend/responsive.css')}}">
...
@section('content')
    ...
    <div class="all-content-wrapper">
                                        ...
                                        <div class="header-right-info">
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                <li class="nav-item dropdown">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="far fa-envelope"></i><span class="indicator-ms"></span></a>
        ...
        {{--<p style="margin-top: 1200px">soldf sdf sfs sdfl</p>--}}

        <div class=" footer-copyright-area footer navbar-fixed-bottom">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
