    ...
    ">
        ...
        ">
                <div>
                    ...
                    <span style="color: black"> Cảm ơn bạn đã tham gia ứng tuyển vào công ty<br/></span>
                    <span style="color: black">Dưới đây là link làm bài test của chúng tôi</span><br/>
                    <span><a href="{{ $info['url'] }}"> Link bài làm</a></span><br/>
                    <span style="color: black">Nếu bạn cần thêm thông tin gì có thể liên lạc với chúng tôi theo thông tin bên dưới: </span><br/>
